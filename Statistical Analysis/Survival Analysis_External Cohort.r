...
ggsave("KMplot_LT_risk_group_external.png", plot = combined_final_plot, width = 10, height = 12, dpi = 300)
...
print(combined_final_plot)
ggsave("KMplot_SR_risk_group_external.png", plot = combined_final_plot, width = 10, height = 12, dpi = 300)
